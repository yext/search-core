...
[fieldType](./search-core.androidappurldirectanswer.fieldtype.md)
...
[EnumOrLiteral](./search-core.enumorliteral.md)<!-- -->&lt;[BuiltInFieldType.AndroidAppURL](./search-core.builtinfieldtype.md)<!-- -->&gt;
