...
|  [coordinates?](./answers-core.verticalsearchrequest.coordinates.md) | [LatLong](./answers-core.latlong.md) | <i>(Optional)</i> The latitude and longitude of the user making the request. Used to bias the results. |
