...
|  [facetFilters?](./answers-core.verticalsearchrequest.facetfilters.md) | SimpleFilter\[\] | <i>(Optional)</i> The [filters](./answers-core.simplefilter.md) to apply to the search |
