...
|  [errorType](./answers-core.failedvertical.errortype.md) | string | The type of error causing the failure. Possible options are "TIMEOUT", "BACKEND\_ERROR", "INVALID\_CONFIG", and "INVALID\_QUERY". |
