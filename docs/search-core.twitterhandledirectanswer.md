...
[fieldType](./search-core.twitterhandledirectanswer.fieldtype.md)
...
[EnumOrLiteral](./search-core.enumorliteral.md)<!-- -->&lt;[BuiltInFieldType.TwitterHandle](./search-core.builtinfieldtype.md)<!-- -->&gt;
