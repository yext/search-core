...
[Home](./index.md) &gt; [@yext/search-core](./search-core.md) &gt; [CustomFieldValueDirectAnswer](./search-core.customfieldvaluedirectanswer.md)

## CustomFieldValueDirectAnswer interface
...
|  --- | --- | --- |
|  [fieldType](./search-core.customfieldvaluedirectanswer.fieldtype.md) | 'unknown' | The field type of the direct answer. |
