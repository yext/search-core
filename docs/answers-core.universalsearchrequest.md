...
|  [location?](./answers-core.universalsearchrequest.location.md) | Location | <i>(Optional)</i> The latitude and longitude of the user making the request. Used to bias the results. |
