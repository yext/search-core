...
|  [matcher](./answers-core.displayablefacetoption.matcher.md) | [Matcher](./answers-core.matcher.md) | A Matcher is the operation by which a [Filter](./answers-core.filter.md) filters by. |
